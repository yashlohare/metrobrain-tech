    ...
    >
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        <div className="hero-btns flex flex-col sm:flex-row items-center justify-center gap-4">
          ...
          <a href="#work" className="group px-8 py-4 border border-white/10 bg-white/5 backdrop-blur-md text-white font-bold tracking-[0.2em] uppercase rounded-xl transition-all hover:bg-white/10 hover:border-white/20 active:scale-95">
            View Showcase
          </a>
        </div>

        {/* Scroll Indicator */}
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-4 text-white/20">
          <span className="text-[10px] font-bold tracking-[0.4em] uppercase vertical-text">Scroll to Explore</span>
