...
import { FiArrowLeft, FiShoppingCart, FiHeart, FiSearch, FiStar } from 'react-icons/fi';
import { Link } from 'react-router-dom';

const products = [
  {
    id: 1,
    name: 'Astron Chronograph',
    price: '$2,450',
    rating: 4.9,
  ...
  },
  {
    ...
    price: '$1,890',
    rating: 4.8,
    image: 'https://images.unsplash.com/photo-1542496658-e33a6d0d50f6?w=600&h=800&fit=crop',
    tag: 'Bestseller'
  },
  {
    id: 3,
  ...
  },
  {
    ...
    price: '$2,150',
    rating: 4.7,
    image: 'https://images.unsplash.com/photo-1614164185128-e4ec99c436d7?w=600&h=800&fit=crop',
    tag: 'New Arrival'
  }
];

const EcommercePrototype = () => {
    ...
    <div className="proto-page luxura-theme">
      ...
      <nav className="proto-nav glass">
        <div className="proto-container flex-between">
          <Link to="/" className="back-link"><FiArrowLeft /> <span>Back to Metrobrain</span></Link>
          <div className="proto-logo">LUXURA</div>
          <div className="proto-nav-right">
            <FiSearch className="proto-icon" />
            <FiHeart className="proto-icon" />
            <div className="proto-cart" onClick={() => setCartCount(c => c + 1)}>
              <FiShoppingCart className="proto-icon" />
              ...
              <div key={product.id} className="product-card glass">
                <div className="product-image">
                  ...
                  <div className="product-actions">
                    <button onClick={() => setCartCount(c => c + 1)}>Quick Add</button>
                  </div>
                </div>
                <div className="product-info">
                  <div className="product-meta">
                    <span className="rating"><FiStar /> {product.rating}</span>
                    <FiHeart className="wishlist-btn" />
                  </div>
                  <h3>{product.name}</h3>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .back-link { display: flex; align-items: center; gap: 10px; color: #aaa; text-decoration: none; font-size: 0.95rem; transition: color 0.3s; font-weight: 500; }
        ...
        .hero-content h1 { font-family: 'Space Grotesk', sans-serif; font-size: 5.5rem; font-weight: 800; margin: 30px 0; max-width: 1000px; line-height: 1.1; letter-spacing: -2px; }
        .hero-subtitle { color: gold; font-weight: 700; text-transform: uppercase; letter-spacing: 10px; font-size: 1.1rem; }
        .hero-content p { font-size: 1.4rem; color: #aaa; max-width: 800px; margin: 0 auto 60px; line-height: 1.6; }
        ...
        .proto-section { padding: 180px 0; }
        .section-header { display: flex; flex-direction: column; align-items: center; text-align: center; margin-bottom: 100px; gap: 30px; width: 100%; }
        .section-header h2 { font-size: 4rem; font-family: 'Space Grotesk', sans-serif; letter-spacing: -1px; font-weight: 800; }
        ...
        .proto-grid-4 { display: grid; grid-template-columns: repeat(4, 1fr); gap: 50px; width: 100%; }
        ...
        .product-image { height: 500px; position: relative; overflow: hidden; background: #111; }
        ...
        .product-tag { position: absolute; top: 30px; left: 30px; background: gold; color: #000; padding: 8px 18px; font-size: 0.8rem; font-weight: 800; border-radius: 4px; z-index: 2; text-transform: uppercase; letter-spacing: 1.5px; }
        ...
        .product-meta { display: flex; justify-content: space-between; align-items: center; margin-bottom: 25px; }
        ...
        .product-info h3 { font-size: 1.5rem; margin-bottom: 15px; font-weight: 800; letter-spacing: 0.5px; }
        .price { font-size: 1.8rem; font-weight: 900; color: #fff; font-family: 'Space Grotesk', sans-serif; }
...
export default EcommercePrototype;
